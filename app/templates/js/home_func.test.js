...
describe('home_func', () => {
    ...
    describe('displayMessage', () => {
        ...
        test('should append a message element with the correct content', () => {
            ...
            const messageElement = document.querySelector('#Conversation .message');
    ...
    describe('getOrCreateConversation', () => {
        ...
        beforeEach(() => {
            ...
            // Reset global and local state before each test
        ...
        test('should handle fetch errors gracefully', async () => {
            // Mock fetch to return a failure
            fetchMock.mockImplementationOnce(() => Promise.reject(new Error('API is down')));
    ...
    describe('loadConversationHistory', () => {
        ...
        test('should load and display the conversation history correctly', async () => {
            await loadConversationHistory(conversationItemsList);
